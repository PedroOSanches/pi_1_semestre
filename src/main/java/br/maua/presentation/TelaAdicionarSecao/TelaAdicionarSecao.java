...
public class TelaAdicionarSecao extends javax.swing.JFrame {
        ...
        private static final java.util.logging.Logger logger = java.util.logging.Logger
                .getLogger(TelaAdicionarSecao.class.getName());
        ...
        private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
                ...
                if (tituloSecao.isEmpty() || descricaoSecao.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Preencha o título, a ordem e a descrição da seção.",
                ...
                try {
                        ...
                        JOptionPane.showMessageDialog(this, "Seção criada com sucesso!", "Sucesso",
                                JOptionPane.INFORMATION_MESSAGE);
                        br.maua.presentation.TelaNavegacao.voltar(this);
                } catch (SQLException e) {
                        JOptionPane.showMessageDialog(this,
                                "Erro ao criar a seção no banco de dados: " + e.getMessage(), "Erro no banco",
