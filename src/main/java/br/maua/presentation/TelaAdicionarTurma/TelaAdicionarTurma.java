...
public class TelaAdicionarTurma extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                comboBoxProfessor.setModel(
                        new DefaultComboBoxModel<>(new Professor[]{new Professor("Carregando...")}));
                ...
                comboBoxSubturma.setModel(
                        new DefaultComboBoxModel<Subturma>(new Subturma[]{new Subturma("Carregando...")}));
                ...
                gapAnoLayout.setHorizontalGroup(
                        gapAnoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(gapAnoLayout.createSequentialGroup()
                                        .addGap(194, 194, 194)
                                        .addGroup(gapAnoLayout.createParallelGroup(
                                                        javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(gapAnoLayout
                                                        .createSequentialGroup()
                                                        .addGroup(gapAnoLayout
                                                                .createParallelGroup(
                                                                        javax.swing.GroupLayout.Alignment.LEADING)
                                                                .addComponent(comboBoxSemestre,
                                                                        0,
                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                        Short.MAX_VALUE)
                                                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                                        gapAnoLayout.createSequentialGroup()
                                                                                .addComponent(comboBoxTurma,
                                                                                        0,
                                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                        Short.MAX_VALUE)
                                                                                .addPreferredGap(
                                                                ...
                                                                .addComponent(comboBoxProfessor,
                                                                        0,
                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                        Short.MAX_VALUE))
                                                        .addGap(205, 205, 205))
                ...
                layout.setHorizontalGroup(
                        layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(gapAno, javax.swing.GroupLayout.DEFAULT_SIZE,
        ...
        private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buttonVoltarActionPerformed
                ...
                try {
                        TurmaSubturmaDAO.commit(
                                (SemestreEnum) Objects.requireNonNull(comboBoxSemestre.getSelectedItem(),
                                        "Selecione o Semestre"),
                                (Professor) Objects.requireNonNull(comboBoxProfessor.getSelectedItem(),
                                        "Selecione o Professor"),
                                (Curso) Objects.requireNonNull(comboBoxCurso.getSelectedItem(),
                                        "Selecione o Curso"),
                                (Ano) Objects.requireNonNull(comboBoxAno.getSelectedItem(), "Selecione o Ano"),
                                (Turma) Objects.requireNonNull(comboBoxTurma.getSelectedItem(),
                                        "Selecione a Turma"),
                                (Subturma) Objects.requireNonNull(comboBoxSubturma.getSelectedItem(),
                                        "Selecione a Subturma"));
