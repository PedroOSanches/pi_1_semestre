...
public class TelaQuestionarioAluno extends JFrame {
    ...
    private static final Logger logger = Logger.getLogger(TelaQuestionarioAluno.class.getName());
    ...
    private void initComponents() {
                ...
                painelCinza1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(painelCinza1Layout.createSequentialGroup()
                                ...
                                .addGroup(painelCinza1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addGroup(painelCinza1Layout.createSequentialGroup()
                                                .addComponent(prazo, GroupLayout.PREFERRED_SIZE,
                                        ...
                                        .addGroup(painelCinza1Layout
                                                ...
                                                .addComponent(painelQuestao, GroupLayout.DEFAULT_SIZE,
        ...
        painelCinza1Layout.setVerticalGroup(
                painelCinza1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(painelCinza1Layout.createSequentialGroup()
                                ...
                                .addGap(31, 31, 31)
                                .addComponent(painelQuestao, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 61, Short.MAX_VALUE)
                                .addGroup(painelCinza1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addComponent(prazo, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnEnviarTarefa2))
                                .addGap(51, 51, 51)));
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addComponent(jScrollPane6, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                                GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
        layout.setVerticalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addComponent(jScrollPane6, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                Short.MAX_VALUE));
