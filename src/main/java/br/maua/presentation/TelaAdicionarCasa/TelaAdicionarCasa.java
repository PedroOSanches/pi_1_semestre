...
public class TelaAdicionarCasa extends javax.swing.JFrame {
        ...
        private static final java.util.logging.Logger logger = java.util.logging.Logger
                .getLogger(TelaAdicionarCasa.class.getName());
        ...
        private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
                ...
                if (secaoSelecionada == null || tituloCasa.isEmpty() || dataLimiteTexto.isEmpty()) {
                        JOptionPane.showMessageDialog(this,
                                "Preencha o número, a seção, o título e a data limite da casa.",
                ...
                try {
                        ...
                        JOptionPane.showMessageDialog(this, "Casa criada com sucesso!", "Sucesso",
                                JOptionPane.INFORMATION_MESSAGE);
                        br.maua.presentation.TelaNavegacao.voltar(this);
                } catch (NumberFormatException e) {
                        JOptionPane.showMessageDialog(this, "Número da casa e seção precisam ser numéricos.",
                                "Valor inválido",
                                JOptionPane.ERROR_MESSAGE);
                } catch (ParseException e) {
                        JOptionPane.showMessageDialog(this, "Digite uma data válida no formato dd/MM/aaaa.",
                                "Data inválida",
                                JOptionPane.ERROR_MESSAGE);
                } catch (SQLException e) {
                        JOptionPane.showMessageDialog(this, "Erro ao criar a casa no banco de dados: " + e.getMessage(),
        ...
        private void carregarSecoesNoCombo() {
                ...
                try {
                        ...
                        JOptionPane.showMessageDialog(this, "Erro ao carregar seções: " + e.getMessage(),
                                "Erro no banco",
                                JOptionPane.ERROR_MESSAGE);
                }
        }
