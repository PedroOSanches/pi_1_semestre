...
public class TelaCorrecaoTarefa extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger
            .getLogger(TelaCorrecaoTarefa.class.getName());
    ...
    private void initComponents() {
        ...
        painelCinza1Layout.setHorizontalGroup(
                painelCinza1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(painelCinza1Layout.createSequentialGroup()
                                .addGap(202, 202, 202)
                                .addGroup(painelCinza1Layout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(titulo3, javax.swing.GroupLayout.DEFAULT_SIZE, 528,
                                                Short.MAX_VALUE)
        ...
        painelCinza1Layout.setVerticalGroup(
                painelCinza1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(painelCinza1Layout.createSequentialGroup()
                                .addGap(28, 28, 28)
                                .addComponent(titulo3, javax.swing.GroupLayout.PREFERRED_SIZE, 88,
                                ...
                                .addGroup(painelCinza1Layout
                                        ...
                                        .addComponent(jButton1)
                                        .addComponent(jScrollPane7, javax.swing.GroupLayout.DEFAULT_SIZE, 452,
                                                Short.MAX_VALUE))
                                .addGap(91, 91, 91)));
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(painelAzul1, javax.swing.GroupLayout.DEFAULT_SIZE,
    ...
    private void popularTela() {
        ...
        for (Resposta resposta : tentativa.getRespostas()) {
            ...
            if (resposta instanceof RespostaDissertativa) {
                ...
                painelAlternativas
                        .setLayout(new javax.swing.BoxLayout(painelAlternativas, javax.swing.BoxLayout.Y_AXIS));
                javax.swing.ButtonGroup alternativas = new javax.swing.ButtonGroup();

                if (respostaAlternativa.getQuestao() != null
                        && respostaAlternativa.getQuestao().getAlternativas() != null) {
                            ...
                            try {
                                ...
                                if (!arquivo.exists()) {
                                    javax.swing.JOptionPane.showMessageDialog(
                                            ...
                                            "O arquivo '" + arquivo.getAbsolutePath()
                                                    + "' não foi encontrado na pasta do servidor.",
                                            "Erro",
                                            javax.swing.JOptionPane.ERROR_MESSAGE);
                                    return;
                                }
